  ...
  return (
    <div className={styles.container}>
      <div className={styles.reaction}>
        ...
        <button className={styles.reactionButtons}><img src="https://cdn.jsdelivr.net/npm/emoji-datasource-apple/img/apple/64/1f44d.png" alt="" /></button>
        <button className={styles.reactionButtons}><img src="https://cdn.jsdelivr.net/npm/emoji-datasource-apple/img/apple/64/2764-fe0f.png" alt="" /></button>
        <button className={styles.reactionButtons}><img src="https://cdn.jsdelivr.net/npm/emoji-datasource-apple/img/apple/64/1f602.png" alt="" /></button>
        <button className={styles.reactionButtons}><img src="https://cdn.jsdelivr.net/npm/emoji-datasource-apple/img/apple/64/1f62e.png" alt="" /></button>
        <button className={styles.reactionButtons}><img src="https://cdn.jsdelivr.net/npm/emoji-datasource-apple/img/apple/64/1f622.png" alt="" /></button>
        <button className={styles.reactionButtons}><img src="https://cdn.jsdelivr.net/npm/emoji-datasource-apple/img/apple/64/1f64f.png" alt="" /></button>
